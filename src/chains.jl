...
alls(c::AbstractChain,i::UnitRange{Int})        = cbind(c.infos[i,:],c.parameters[i,:],c.moments[i,:])
alls(c::AbstractChain,i::Int)                   = cbind(infos(c, i:i),parameters(c, i:i),moments(c, i:i))
